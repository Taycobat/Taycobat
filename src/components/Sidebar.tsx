  ...
  return (
    <motion.aside initial={{ x: -20, opacity: 0 }} animate={{ x: 0, opacity: 1 }} transition={{ duration: 0.3 }}
      ...
      <nav className="flex-1 px-3 py-3 space-y-0.5 overflow-y-auto">
        ...
        {email === ADMIN_EMAIL && (
          <NavLink to="/admin" className={({ isActive }) => `flex items-center gap-3 px-3 py-2 rounded-xl text-[13px] font-medium transition-all ${isActive ? 'bg-[#1a9e52]/10 text-[#1a9e52]' : 'text-gray-500 hover:bg-gray-50 hover:text-gray-700'}`}>
