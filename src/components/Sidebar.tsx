...
export default function Sidebar() {
  ...
  return (
    <motion.aside
      ...
      className="w-[260px] min-h-screen bg-white border-r border-gray-200 flex flex-col"
    >
      {/* Logo */}
      <div className="px-6 h-16 flex items-center gap-3 border-b border-gray-100">
        ...
        <div>
          <span className="text-[15px] font-bold text-gray-900 tracking-tight">TAYCO BAT</span>
          <span className="block text-[11px] text-gray-400 -mt-0.5">Gestion BTP</span>
        </div>
      </div>
